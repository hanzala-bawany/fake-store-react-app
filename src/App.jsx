  ...
  return (
    ...
    <>
        ...
        <Routes>
          ...
          <Route path='/' element={<Home cities={cities} setSelectedCityIndex={setSelectedCityIndex} />} />
          <Route path='/Conatact' element={<Conatact />} />
          <Route path='/About' element={<About />} />
          <Route path='/Registration' element={<Registration />} />

          <Route path='/:cityName/foodItems' element={<FoodItems allFoodItems={allFoodItems} selectedCity={cities[selectedCityIndex]} />} />
          <Route path='/:cityName/FoodItem/:id' element={<FoodItem allFoodItems={allFoodItems} />} />
